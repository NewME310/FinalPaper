...
\begin{appendices}
%\include{AppendixErika}
\include{Appendix_blue_print}
\include{Appendix_previous_quarters}
\include{Appendix_survey}
\include{Appendix_air_france}
\include{Appendix_analysis_cargo_hold}     
\include{Appendix_app}  
\include{Appendix_code}  
\include{Appendix_materials}
\include{Appendix_eng}
 \end{appendices}
